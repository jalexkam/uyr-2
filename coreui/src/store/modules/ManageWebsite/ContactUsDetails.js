...
export const actions = {
  ...
  edit: ({ commit }, payload) => {
        return new Promise((resolve, reject) => {
            axios
                .get('/api/manageWebsite/contactUs/' + payload)
                .then((response) => {
 ...
 UpdateMultiAction: ({ commit, dispatch }, payload) => {
      return new Promise((resolve, reject) => {
          axios
              .delete('/api/manageWebsite/contactUs/' + payload.id + '?action=' + payload.action)
              .then((response) => {
 ...
 submitForm: ({ commit, dispatch }, payload) => {
    return new Promise((resolve, reject) => {
        if (payload.id == '') {
            var post_url = axios.post('/api/manageWebsite/contactUs', payload);
        } else {
            var post_url = axios.patch('/api/manageWebsite/contactUs/' + payload.id, payload);
        }
        return post_url
            .then((response) => {
