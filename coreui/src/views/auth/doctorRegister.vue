        ...
        <CCol lg="6">
          <div class="log_head">
           <!--  <CButton class="home_button" :to="{ name: 'homepage' }"> <vue-fontawesome icon="home" class="mr-2 my-0" size="1.1"> </vue-fontawesome>Home </CButton> -->
            <!-- <span>|</span> -->
            <CButton to="register" size="sm"><vue-fontawesome icon="user-md" class="mr-2 my-0" size="1.1"> </vue-fontawesome>for user</CButton>
          </div>
                  ...
                  <CRow>
                    ...
                    <!-- <CCol sm="6">
                          <div class="pos_relative">
                           ...
                           <small v-if="ajax_error.errors.user_name" class="text-danger mb-0">
...
import Ufooter from '../frontend/footer'
  ...
  export default {
    ...
    methods: {
      ...mapActions("auth", ["registerDoctor", "resetState", "fetchUser"]),
