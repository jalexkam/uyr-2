      ...
      <CRow class="m-0">
         <CCol sm="12" class="px-2 btn-sticky">
            <div class="d-flex justify-content-between py-2 align-items-center">
               <h5 class="mb-0">Why work for us <vue-fontawesome icon="caret-right" class="px-1" size="1"></vue-fontawesome>Edit</h5>
               <div class="">
               </div>
            </div>
         </CCol>
         <CCol sm="9" class="p-2">
            <CCard class="mb-0">
               <CCardHeader class="p-2 px-3 bg_themes">
                  <div>
                     <strong>Why work for Details</strong>
                  </div>
               </CCardHeader>
                  ...
                  <CForm  >
                     <CRow class="m-0">   
                        <CCol md="12" class="px-2">
                           <CInput label="Title" placeholder="" v-model="formData.title"/>
                        </CCol>
                        
                        <CCol sm="12" class="px-2">
                           <div class="form-group">
                              <label>Why work for Description</label>
...
<script>
   ...
   data() {
        return {
            ...
            show:false,
            showModal: true,
            formData : new Form({id:'', title:'',description:'',status:1,pageName:'Why-work'}),
            aboutus_picture  : '',
            imageDoc         : [],
            id:0,
          }
   ...
   methods: {
      ...mapActions("ManageWebsite/AboutUS", ["submitForm","whyusedit"]),
