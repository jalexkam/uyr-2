                     ...
                     <CRow class="m-0"> 
                        <CCol sm="12" md="12" class="px-2">
                           <div class="form-group">
                              ...
                              <div class="blogimg">
                              <img :src="'uploads/blog/'+editData.id+'/'+editData.image_name" v-if="editData.image_name && imageDoc ==''">
...
<script>
   ...
   components: {
    ...
    data() {
     ...
     computed: {
         ...mapGetters("ManageWebsite/Blog", ["returnData","editData"]),
      },
      

      methods: {
         ...mapActions("ManageWebsite/Blog", ["submitForm","edit"]),
         ...
         onImageChange(e) {
          ...
          submitFormData() {
             ...
             this.submitForm({newData:newData,id:this.id}).then(() => {
