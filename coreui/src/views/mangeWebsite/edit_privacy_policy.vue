      ...
      <CRow class="m-0">
         <CCol sm="12" class="px-2 btn-sticky">
            <div class="d-flex justify-content-between py-2 align-items-center">
               <h5 class="mb-0">Privacy Policy <vue-fontawesome icon="caret-right" class="px-1" size="1"></vue-fontawesome>Edit</h5>
               <div class="">
               </div>
            </div>
         </CCol>
         <CCol sm="9" class="p-2">
            <CCard class="mb-0">
               <CCardHeader class="p-2 px-3 bg_themes">
                  <div>
                     <strong>Privacy Policy Details</strong>
                  </div>
               </CCardHeader>
...
<script>
   ...
   data() {
        return {
            ...
            show:false,
            showModal: true,
            formData : new Form({id:'', title:'',description:'',status:1,pageName:'privacy-policy'}),
            aboutus_picture  : '',
            imageDoc         : [],
            id:0,
          }
   ...
   methods: {
      ...mapActions("ManageWebsite/AboutUS", ["submitForm","privacypolicyedit"]),
