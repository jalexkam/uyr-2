    ...
    <CRow class="m-0">
      <CCol sm="12" class="p-2">
        <div class="d-flex justify-content-between align-items-center">
          <h5 class="mb-0">Doctor Payout</h5>
        </div>
      </CCol>
    </CRow>
    <CRow class="m-0">
            ...
            <CRow class="m-0">
              ...
              <CCol sm="3" class="px-1">
                <div class="sub-filter mt-2">
                 ...
                 <CButton class="btn btn-sm btn-dark"  :href="'/api/payouts/exportToDoctorCsv?SearchMonthYear='+SearchMonthYear">
  ...
  export default {
    ...
    methods: {
      ...
      paginateHandle(pageNum) {
        this.$router.push({ name: "doctor-payout-page", params: { page: pageNum } });
      ...
      searchData() {
        var page = 1;
          if (this.$route.params.page != 1) 
            this.$router.push({ name: "doctor-payout-page", params: { page: page } });
