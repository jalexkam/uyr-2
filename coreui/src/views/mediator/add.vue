      ...
      <form class="validate-form" @submit.prevent="submitFormData">
        <CCol sm="12" class="px-2 btn-sticky">
          <div class="d-flex justify-content-between py-2 align-items-center">
            <h5 class="mb-0">Mediator Doctor <vue-fontawesome icon="caret-right" class="px-1" size="1"></vue-fontawesome>Add</h5>
            <div class="">
              <CButton type="submit" class="btn_custom">Submit</CButton>
                ...
                <CCol sm="12" md="9" class="px-2">
                  <CRow class="m-0">
                    <CCol sm="6" md="4" class="px-2">
                      ...
                      <CInput v-model="formData.first_name" placeholder="Enter First Name" v-on:keypress="isLetter($event)" :class="[ajax_error.errors.first_name ? 'formError' : '']"/>
                      <span class="text-danger" v-if="ajax_error.errors.first_name">{{ ajax_error.errors.first_name[0] }}</span>
                    </CCol>
                    <CCol sm="6" md="4" class="px-2">
                      <label>Last Name <span class="text-danger">*</span></label>
                      <CInput placeholder="Enter Last Name" v-model="formData.last_name" v-on:keypress="isLetter($event)" :class="[ajax_error.errors.last_name ? 'formError' : '']"/>
                    ...
                    <CCol sm="6" md="4" class="px-2">
                      ...
                      <CInput for="email" v-model="formData.email" placeholder="Enter Email" :class="[ajax_error.errors.email ? 'formError' : '']"/>
                    ...
                    <CCol sm="6" md="4" class="px-2">
                      ...
                      <CInput type="password" v-model="formData.password" placeholder="Enter Password" :class="[ajax_error.errors.password ? 'formError' : '']"/>
                    ...
                    <CCol sm="6" md="4" class="px-2">
                      <label>Age</label>
                      <CInput v-model="formData.age" placeholder="Enter Age" />
                    ...
                    <CCol sm="6" md="3" class="px-2">
                      <div class="form-group">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" value="0" v-model="formData.gender" id="customRadioInline1" name="gender" class="custom-control-input" :class="[ajax_error.errors.date_of_registration ? 'formError' : '']"/>
          ...
          <CCard class="mb-0">
            ...
            <CCardBody class="px-1 py-2">
              <CRow class="m-0">
                ...
                <!-- <CCol sm="6" md="4" class="px-2">
                  <div class="form-group">
                    <label>Enter your availability<span>*</span></label>
                ...
                <CCol sm="12" class="px-2">
                  <div class="form-group">
                    ...
                    <textarea rows="6" placeholder="Enter Brief summary" class="form-control" v-model="formData.brief_summary"></textarea>
                  </div>
                </CCol>
                <CCol sm="12" class="px-2">
                  <div class="form-group">
                    <label>Terms and condition (policy and procedure of working together)</label>
                    <textarea rows="6" class="form-control" placeholder="Enter Terms and condition" v-model="formData.terms_and_conditions"></textarea>
                  </div>
                </CCol>
              </CRow>
            </CCardBody>
...
<script>
  ...
  export default {
    ...
    mounted() {},
    computed: {
      ...mapGetters("Mediator/Index", ["returnData", "ajax_error"]),

      ...mapGetters("auth", ["user"]),
      ...mapGetters("Doctor/Index", ["equipListResult"]),
    ...
    methods: {
      ...mapActions("Mediator/Index", ["submitForm"]),

      ...mapActions("Doctor/Index", ["getEquipmentList"]),
      ...
      submitFormData() {
        ...
        this.submitForm({ newData: newData })
          .then(() => {
