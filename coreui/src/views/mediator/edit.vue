      ...
      <form class="validate-form" @submit.prevent="submitFormData">
        <CCol sm="12" class="px-2 btn-sticky">
          <div class="d-flex justify-content-between py-2 align-items-center">
            <h5 class="mb-0">Mediator Doctor <vue-fontawesome icon="caret-right" class="px-1" size="1"></vue-fontawesome>Update</h5>
            <div class="">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters("Mediator/Index", ["returnData", "ajax_error", "doctorResult"]),
    ...
    methods: {
      ...mapActions("Mediator/Index", ["submitMediatorUpdateForm", "getMediatorData"]),
      ...
      submitFormData() {
        ...
        this.submitMediatorUpdateForm({ newData: newData, id: this.formData.id })
          .then(() => {
