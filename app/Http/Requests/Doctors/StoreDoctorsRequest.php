...
class StoreDoctorsRequest extends FormRequest
{
    ...
    {   
       ...
       // if($formData->area =='')        $arr_rules['area']     = 'required';
        ...
        //if($formData->latitude =='')    $arr_rules['latitude']  = 'required';
        //if($formData->longitude =='')   $arr_rules['longitude'] = 'required';
        

      // if($formData->type =='') $arr_rules['type']   = 'required';
        //$arr_rules['certificate_awarding_university']   = 'required';
        //$arr_rules['speciality_diploma']                = 'required';
        //$arr_rules['medical_council_regn']              = 'required';
        ...
        //$arr_rules['copy_of_registration']              = 'required';
        //if($formData->current_clinic_hospital =='') $arr_rules['current_clinic_hospital']= 'required';
        return $arr_rules;
    }
